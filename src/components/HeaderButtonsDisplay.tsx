...
const HeaderButtonsDisplay = () => {
  ...
  return <div className="flex flex-wrap gap-2 justify-center">
      {buttons.map(button => <Link key={button.id} to={button.url} className="flex flex-col items-center justify-center bg-white hover:bg-gray-100 text-gray-800 rounded-lg font-medium py-2 px-4 transition-all duration-200 hover:-translate-y-1 text-center shadow-sm w-[120px] h-[70px]">
